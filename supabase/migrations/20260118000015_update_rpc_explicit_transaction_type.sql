-- Migration: Fix RPC function confirm_booking_payment to include transaction_type explicity
-- Description: Updates the insert into earnings to explicitly set transaction_type = 'earning'.
...
BEGIN
  ...
  -- Create Earning Record (Updated to include transaction_type)
  INSERT INTO public.earnings (
    ...
    'pending',
    NOW(),
    'earning' -- Explicitly set transaction_type
  );

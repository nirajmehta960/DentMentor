  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 opacity-20">
        ...
        <div
          className="absolute bottom-20 right-10 w-48 h-48 bg-secondary-light rounded-full blur-3xl animate-pulse"
          style={{ animationDelay: "1s" }}
        ></div>
        <div
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-primary-light rounded-full blur-3xl animate-pulse"
      ...
      <div className="container mx-auto px-3 sm:px-4 md:px-6 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          {/* Logo */}
          <div
            className={`inline-flex items-center gap-2 sm:gap-3 mb-6 sm:mb-8 scroll-animate ${
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-white mb-4 sm:mb-6 leading-tight px-2">
            ...
            <span
              className={`block scroll-animate stagger-2 ${
                heroVisible ? "animate-in" : ""
              } bg-gradient-to-r from-white to-accent-light bg-clip-text text-transparent`}
            >
              Expert Mentors
            </span>
            <span
          ...
          {/* Subtitle */}
          <p
            className={`text-base sm:text-lg md:text-xl lg:text-2xl text-white/90 mb-8 sm:mb-10 md:mb-12 max-w-3xl mx-auto leading-relaxed px-4 scroll-animate stagger-4 ${
              heroVisible ? "animate-in" : ""
            }`}
          >
            Join 50+ international dental graduates who've successfully
            navigated the U.S. dental licensing process with personalized
            mentorship from verified experts.
          </p>

          {/* CTA Buttons */}
          <div
            className={`flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center px-4 scroll-animate stagger-5 ${
              heroVisible ? "animate-in" : ""
            }`}
          >
            <Button

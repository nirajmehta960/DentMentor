  ...
  return (
    <section ref={sectionRef} className="py-20 bg-background">
      <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {focusAreas.map((area, index) => {
              ...
              return (
                <div
                  key={index}
                  className={`card-hover rounded-3xl p-8 scroll-animate ${
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {sessionTypes.map((session, index) => {
              ...
              return (
                <div
                  key={index}
                  className={`card-hover rounded-3xl p-8 text-center relative overflow-hidden scroll-animate ${
                    sectionVisible ? "animate-in" : ""
                  } group ${
                ...
                >
                  ...
                  <div className="relative z-10">
                    <div
                      className={`flex items-center justify-center w-16 h-16 bg-gradient-${
                        index % 2 === 0 ? "secondary" : "accent"
        ...
        {/* Call to Action */}
        <div
          className={`text-center bg-gradient-primary rounded-3xl p-8 md:p-12 text-white scroll-animate ${
            sectionVisible ? "animate-in" : ""
          }`}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8 max-w-3xl mx-auto text-left">
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 hover:bg-white/20 hover:scale-105 transition-all duration-300 cursor-pointer group">
              <div className="font-semibold mb-2 group-hover:scale-105 transition-transform">

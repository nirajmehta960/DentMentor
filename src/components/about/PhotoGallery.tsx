      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className={`text-xl text-muted-foreground max-w-3xl mx-auto transition-all duration-1000 delay-200 ${
            ...
            A glimpse into our journey, from team moments to milestone celebrations and everything in between.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {galleryImages.map((image, index) => (
            ...
            >
              <div className="relative overflow-hidden rounded-2xl shadow-soft hover:shadow-large transition-all duration-300">
                <img
                  src={image.src}
                  alt={image.alt}
        ...
        <div className={`text-center mt-16 transition-all duration-1000 delay-500 ${
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 max-w-3xl mx-auto">
            ...
            <div className="p-6 bg-white rounded-2xl shadow-soft">
              ...
              <div className="text-sm text-muted-foreground">Conferences attended</div>
            </div>
            <div className="p-6 bg-white rounded-2xl shadow-soft">
              <div className="text-2xl font-bold text-primary mb-2">1000+</div>
              <div className="text-sm text-muted-foreground">Moments captured</div>
            </div>
          </div>
        </div>
      </div>
